//This java file to create connectivity between mysql and stock application
package stock;
import java.sql.*;
public class CJdbc
{
		...
		try
	 	{
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_stock","root","bebo123");
