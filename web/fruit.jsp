...
ResultSet rs=null;
CJdbc obj=new CJdbc( );
String query="select Itemname,  CurrentStock from tblFruitItems ";
...
<td><a href="DeleteItem.jsp?ItemName=<%=rs.getString("Itemname")%>&ItemType=Fruits">Delete</a> </td>
</tr>
<%
}
%>
...
<br>
<br>
<a href="AddNew.jsp?ItemType=Fruits">Add New Item</a>
<br><br>
