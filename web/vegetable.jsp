...
<br>
<br>
<u> <b> Stock of Vegetable Items: </u> </b>
<br>
<br>
<%@ page import="stock.*"%>
...
ResultSet rs=null;
CJdbc obj=new CJdbc( );
String query="select Itemname,  CurrentStock from tblVegetableItems ";
...
<td><a href="DeleteItem.jsp?ItemName=<%=rs.getString("Itemname")%>&ItemType=Vegetables">Delete</a> </td>
...
<br>
<br>
<a href="AddNew.jsp?ItemType=Vegetables">Add New Item</a>
<br><br>
